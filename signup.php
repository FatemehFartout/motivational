...
<form name="signup" action="action_signup.php" method="GET">
    <table style="margin-left:auto;margin-right:auto;height:100%;width:100%;" >
    <tr>
    <br><br>
        <td style="width:40%;">نام<span style="color:red;">*</span></td>
        <td style="width:60%;"><input type="text" id=" name" name=" name"/></td>
</tr>
<tr>
...
<tr>
        ...
        <td style="width:60%;"><input type="email" id="email" name="email"/></td>
</tr>
<tr>
        <td style="width:40%;">نوع<span style="color:red;">*</span></td>
        <td style="width:60%;"><input type="type" id="type" name="type"/></td>
</tr>
<tr>
    <td><br/> <br/></td><br>
        <input class="b" type="submit" value="ثبت نام" onclick="check_empty();"/>
   </td>
</tr>
</table>
</form>  
